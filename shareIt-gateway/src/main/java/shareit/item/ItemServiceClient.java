...
import shareit.item.dto.CommentDtoIncome;
import shareit.item.dto.CommentDtoOutcome;
import shareit.item.dto.ItemDtoIncome;
import shareit.item.dto.ItemDtoOutcomeAvailableRequest;
import shareit.item.dto.ItemDtoOutcomeLong;
...
public class ItemServiceClient {
    ...
    public ItemServiceClient(@Value("${user-service.url}") String userServiceUrl, RestTemplateBuilder builder) {
